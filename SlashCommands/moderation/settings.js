  ...
  run: async (client, interaction, args) => {
    ...
    if (subcommand === "edit") {
      ...
      const embed1 = new MessageEmbed({
        ...
        title: `Settings`,
        color: "#a6ec6c",
        description: "Use '/settings edit' to edit the settings below",
        fields: [
          {
            name: `❯ Channel Configurations`,
            value: `<:down:931548097979486248> \`Ticket panel\`: <#${
              data1.ChannelId || "No data"
            }>\n<:down:931548097979486248> \`Transcripts\`: <#${
              data1.TranscriptId || "No data"
            }>\n<:down:931548097979486248> \`Category [BETA]\`: <#${
              data1.CategoryId || "No data"
            }>`,
            inline: true,
          },
          {
            name: `❯ Role Configurations`,
            value: `<:down:931548097979486248> \`Blacklist\`: <@&${
              data1.TicketBLId || "No data"
            }>\n<:down:931548097979486248> \`Manager\`: <@&${
              data1.Managers || "No data"
            }>`,
            inline: false,
          },
          {
            name: `Buttons`,
            value: `\`${data1.Buttons}\`` || "No buttons registered",
          },
        ],
      });
